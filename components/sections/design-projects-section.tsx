...
const designProjects = [
  ...
  },
  {
    ...
    description: "Custom logo designs for various businesses in Uttarakhand.",
    height: "medium",
  },
  {
    id: 10,
    ...
    category: "Print Design",
    image: "/wedding-invitation-card-design-elegant-floral.jpg",
    description: "Beautiful wedding invitation designs with traditional and modern elements.",
    height: "tall",
  },
]
...
export function DesignProjectsSection() {
  ...
  return (
    <section id="design-work" className="py-24 md:py-32 bg-secondary/20" ref={ref}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <span className="text-primary text-sm font-medium uppercase tracking-wider">Design Projects</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2 mb-4 text-balance">
            Graphic Design Work in Dehradun
          </h2>
          ...
          {designProjects.map((project, index) => (
            ...
            >
              <img
                ...
                alt={`${project.title} - Graphic design by Vikas Ramola in Dehradun`}
              ...
              <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <span className="px-2 py-1 text-xs bg-background/80 backdrop-blur-sm rounded-full text-foreground font-medium">
                  Click to Preview
                </span>
              </div>
            </motion.div>
        ...
        {selectedProject && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-5xl mx-4 bg-card/50 backdrop-blur-xl border border-border/50 rounded-2xl overflow-hidden shadow-2xl"
            ...
            >
              ...
              <div className="relative">
                ...
                <button
                  onClick={handlePrev}
                  className="absolute left-4 top-1/2 -translate-y-1/2 z-10 p-3 bg-background/80 backdrop-blur-sm rounded-full hover:bg-background transition-colors shadow-lg"
                ...
                <button
                  onClick={handleNext}
                  className="absolute right-4 top-1/2 -translate-y-1/2 z-10 p-3 bg-background/80 backdrop-blur-sm rounded-full hover:bg-background transition-colors shadow-lg"
                ...
                >
                  <motion.img
                    ...
                    alt={`${selectedProject.title} - Graphic design by Vikas Ramola`}
              ...
              <div className="p-6 bg-secondary/30 border-t border-border/50">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold text-foreground mb-2">{selectedProject.title}</h3>
                    <p className="text-muted-foreground text-sm md:text-base">{selectedProject.description}</p>
                  </div>
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-500 text-white rounded-xl font-medium hover:bg-green-600 transition-colors shrink-0 shadow-lg shadow-green-500/20"
                  >
              ...
              {/* Thumbnail Strip */}
              <div className="px-4 py-3 bg-background/50 border-t border-border/50 overflow-x-auto">
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 text-xs text-muted-foreground">
              ...
              <span className="flex items-center gap-1">
                <kbd className="px-2 py-1 bg-secondary rounded text-foreground">ESC</kbd>
                Close
              </span>
            </div>
          </motion.div>
