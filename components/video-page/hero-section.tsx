    ...
    <section className="py-16 md:py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            Professional AI-powered video editing services for YouTube, Instagram, podcasts, events, and more. Serving
            businesses and creators across Rishikesh, Dehradun, and all of Uttarakhand with fast turnarounds and premium
            quality.
          </motion.p>
          ...
          >
            ...
            <a
              href="https://wa.me/916398828373?text=Hi%2C%20I%20need%20video%20editing%20services%20in%20Rishikesh."
              target="_blank"
