      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-10">
            Get started with AI-powered video editing services in Rishikesh and Dehradun. Fast turnaround, premium
            quality, competitive rates.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.a
              href="https://wa.me/916398828373?text=Hi%2C%20I%20need%20video%20editing%20services."
              target="_blank"
