  ...
  return (
    <section className="py-24 md:py-32 bg-background" ref={ref}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-balance">Experience the AI Advantage</h2>
          <p className="text-lg text-muted-foreground mb-10">
            Get started with AI-powered creative services in Rishikesh and Dehradun. Faster delivery, better quality,
